...
# Requires    : ScRNA_Analysis_Functions.R, custom_seurat.R
# =============================================================================
...
source("/home/mvergara/projects2/eleo/ScRNA/metodologia/custom_seurat.R")
source("/home/mvergara/projects2/eleo/ScRNA/metodologia/ScRNA_Analysis_Functions.R")
...
# Load samples without quality filters to inspect raw distributions
...
# =============================================================================
# CELL COUNT PER CLUSTER (BY SAMPLE)
# =============================================================================
...
# Step 1: Find and cache marker genes
markers <- find_markers(
  pbmc_harmony,
  output_file = file.path(output_dir, "FindAllMarkers_0.3C.tsv")
)

# Step 2a: Annotate using a curated marker reference list
...
# Step 2b: Annotate by label transfer from a published reference object
